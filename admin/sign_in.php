    	...
    	<div class="form-container sign-up-container">
    		<form action="index2.html">
    			...
    			<div class="social-container">
    				...
    				<a href="#" class="social goog"><i class="fa  fa-google-plus"aria-hidden="true"></i></a>
    				<a href="#" class="social link"><i class="fa  fa-linkedin"aria-hidden="true"></i></a>
    			</div>
    			<span>or use your email for registration</span>
          <input type="text" placeholder=" Vechile Registration ID" required/>
    			<input type="text" placeholder="Vechile Number" required />
